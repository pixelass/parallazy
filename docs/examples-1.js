...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _from=require("babel-runtime/core-js/array/from"),_from2=_interopRequireDefault(_from),_src=require("../src"),_src2=_interopRequireDefault(_src),_examples=require("./examples-1.css"),_examples2=_interopRequireDefault(_examples),$=function(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:document;return(0,_from2.default)(r.querySelectorAll(e))};$(".parallazy").forEach(function(e){var r=$(".inner",e);new _src2.default({classNames:{visibleX:_examples2.default.visibleX,visibleY:_examples2.default.visibleY,pluginLoaded:_examples2.default.pluginLoaded},entering:!1,offset:{top:0,bottom:0,left:0,right:200},onProgress:function(e){var t=(100*e.top).toFixed(8);r[0].style.transform="translate3d("+t+"%,0,0)"},onTop:function(){r[0].style.transform="translate3d(100%,0,0)"},onBottom:function(){r[0].style.transform="translate3d(0%,0,0)"}}).init(e)});
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var minMax=function(n){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1,e=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0;return Math.max(e,Math.min(t,n))},isCallback=function(n){return"function"==typeof n},inBound=function(n){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1;return n>(arguments.length>2&&void 0!==arguments[2]?arguments[2]:0)&&n<t};exports.minMax=minMax,exports.inBound=inBound,exports.isCallback=isCallback;

},{}],115:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.PLUGIN_NAME=void 0;var _promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),_toConsumableArray2=require("babel-runtime/helpers/toConsumableArray"),_toConsumableArray3=_interopRequireDefault(_toConsumableArray2),_keys=require("babel-runtime/core-js/object/keys"),_keys2=_interopRequireDefault(_keys),_extends2=require("babel-runtime/helpers/extends"),_extends3=_interopRequireDefault(_extends2),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_eventListeners=require("./event-listeners"),_helpers=require("./helpers"),_parallize=require("./parallize"),_parallize2=_interopRequireDefault(_parallize),PLUGIN_NAME="Parallazy",PLUGIN_DEFAULTS={classNames:{visibleX:"visible-x",visibleY:"visible-y",pluginLoaded:"pluginLoaded"},entering:!0,offset:{top:0,right:0,bottom:0,left:0},decimals:10,events:["scroll","resize"],onProgress:null,onTop:null,onRight:null,onBottom:null,onLeft:null},Parallazy=function(){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return(0,_classCallCheck3.default)(this,e),this.options=(0,_extends3.default)({},PLUGIN_DEFAULTS,t),this.state={},this.methods}return(0,_createClass3.default)(e,[{key:"init",value:function(e){var t=this.options.classNames.pluginLoaded;this.el=e,e.classList.add(t),this.onInit(e)}},{key:"destroy",value:function(){var e,t=this,s=this.options.classNames,i=(0,_keys2.default)(s).map(function(e){return s[e]});this.options.events.forEach(function(e){t["cancel_"+e]()}),(e=this.el.classList).remove.apply(e,(0,_toConsumableArray3.default)(i))}},{key:"onInit",value:function(){var e=this,t=(0,_parallize2.default)(this.el,{offset:this.options.offset,entering:this.options.entering,decimals:this.options.decimals});this.options.events.forEach(function(t){e["cancel_"+t]=(0,_eventListeners.requestEventListener)(t,function(){e.checkForItems().then(e.handleProgress.bind(e)).catch(function(e){return e})})}),this.handleProgress(t)}},{key:"handleProgress",value:function(e){var t=this.options.decimals,s=1/Math.pow(10,t),i=-1*s,l=1+s,o={x:(0,_helpers.inBound)(e.right,l,i),y:(0,_helpers.inBound)(e.bottom,l,i)};if(this.currentClasses(o),(0,_helpers.isCallback)(this.options.onProgress)&&o.x&&o.y)this.options.onProgress({top:(0,_helpers.minMax)(e.top),right:(0,_helpers.minMax)(e.right),bottom:(0,_helpers.minMax)(e.bottom),left:(0,_helpers.minMax)(e.left)}),this.state={};else if(o.x){if((0,_helpers.isCallback)(this.options.onTop)&&e.top>1){if(this.state.top)return;this.options.onTop(),this.state.top=!0}else if((0,_helpers.isCallback)(this.options.onBottom)&&e.top<0){if(this.state.bottom)return;this.options.onBottom(),this.state.bottom=!0}}else if(o.y)if((0,_helpers.isCallback)(this.options.onLeft)&&e.left>1){if(this.state.left)return;this.options.onLeft(),this.state.left=!0}else if((0,_helpers.isCallback)(this.options.onRight)&&e.left<0){if(this.state.right)return;this.options.onRight(),this.state.right=!0}}},{key:"currentClasses",value:function(e){var t=e.x,s=e.y,i=this.options.classNames,l=i.visibleX,o=i.visibleY;this.el.classList.toggle(l,t),this.el.classList.toggle(o,s)}},{key:"checkForItems",value:function(){var e=this;return new _promise2.default(function(t,s){var i=e.options.offset,l=i.top,o=i.right,r=i.bottom,n=i.left,a={top:(0,_helpers.isCallback)(l)?l():l,right:(0,_helpers.isCallback)(o)?o():o,bottom:(0,_helpers.isCallback)(r)?r():r,left:(0,_helpers.isCallback)(n)?n():n},h=(0,_parallize2.default)(e.el,{offset:a,entering:e.options.entering,decimals:e.options.decimals});return h?t(h):s(new Error("progress should be an object."))})}},{key:"methods",get:function(){return{init:this.init.bind(this),destroy:this.destroy.bind(this)}}}]),e}();exports.PLUGIN_NAME=PLUGIN_NAME,exports.default=Parallazy;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _extends2=require("babel-runtime/helpers/extends"),_extends3=_interopRequireDefault(_extends2),_helpers=require("./helpers"),parallize=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=(0,_extends3.default)({entering:!0,offset:{},decimals:2},t),r=(0,_extends3.default)({top:0,left:0,right:0,bottom:0},i.offset),o=e.getBoundingClientRect(),l=o.top,n=o.left,d=o.height,h=o.width,f=window,p=f.innerHeight,s=f.innerWidth,a=i.decimals,u=i.entering,x={left:n-r.left,top:l-r.top,width:s-(r.left+r.right),height:p-(r.top+r.bottom)},_=0,g=0;u?(_=(x.left+h)/(x.width+h),g=(x.top+d)/(x.height+d)):(_=x.left/(x.width-h),g=x.top/(x.height-d));var m=1/Math.pow(10,a),c=-1*m,w=1+m,b={x:(0,_helpers.minMax)(_,w,c),y:(0,_helpers.minMax)(g,w,c)};return{top:(1-b.y).toFixed(a),right:b.x.toFixed(a),bottom:b.y.toFixed(a),left:(1-b.x).toFixed(a)}};exports.default=parallize;
